...
import com.example.gpgrocery.Activity.MainActivity;
import com.example.gpgrocery.Activity.SignUpActivity;
import com.example.gpgrocery.R;
import com.example.gpgrocery.databinding.FragmentAddStockBinding;
import com.example.gpgrocery.databinding.FragmentLogoutBinding;
...
public class LogoutFragment extends Fragment {
    ...
    private void init() {
        sharedPref1 = requireContext().getSharedPreferences("login_details", Context.MODE_PRIVATE);

        SharedPreferences.Editor editor = sharedPref1.edit();
        editor.clear();
        editor.apply();

        intentLogin = new Intent(requireContext(), MainActivity.class);
